...
% Downloaded at https://fr.mathworks.com/matlabcentral/fileexchange/32578-superkron
...
% We do the product
M = reshape(varargin{1},my_numel(varargin{1}),1) * reshape(varargin{2},1,my_numel(varargin{2}));
